        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex items-center gap-2 px-3 pt-2 pb-2 border-b dark:border-white/10 border-black/10 shrink-0">
                ...
                <input
                    ...
                    className="flex-1 bg-transparent text-sm dark:text-white text-gray-900 placeholder:dark:text-white/30 placeholder:text-gray-400 outline-none"
                ...
                {searchQuery && (
                    <button
                        ...
                        className="w-5 h-5 flex items-center justify-center rounded-full dark:bg-white/20 bg-black/10 dark:text-white/60 text-gray-500 text-xs shrink-0"
                        aria-label="Obriši"
                    >
                        ×
                    </button>
                ...
                <button
                    onClick={closeSearch}
                    className="text-sm dark:text-white/50 text-gray-500 dark:hover:text-white/80 hover:text-gray-800 transition-colors shrink-0 pl-1"
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                {stopResults.map((stop) => (
                                    <button
                                        ...
                                        className="flex items-center justify-between gap-3 px-3 py-2.5 rounded-xl dark:bg-white/5 bg-black/5 dark:border-white/10 border-black/10 border text-left w-full dark:hover:bg-white/10 hover:bg-black/8 transition-colors"
                                    >
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                {lineResults.map((line) => (
                                    <button
                                        ...
                                        className="flex items-center gap-3 px-3 py-2.5 rounded-xl dark:bg-white/5 bg-black/5 dark:border-white/10 border-black/10 border text-left w-full dark:hover:bg-white/10 hover:bg-black/8 transition-colors"
                                    >
                                        <span
                ...
                {!hasQuery && (
                    <>
                        ...
                        {recentStops.length === 0 && recentLines.length === 0 && favouriteStops.length === 0 && (
                            <p className="text-sm dark:text-white/30 text-gray-400 text-center py-6">
